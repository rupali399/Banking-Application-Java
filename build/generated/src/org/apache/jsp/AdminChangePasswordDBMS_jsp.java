...
public final class AdminChangePasswordDBMS_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 Connection con=null; 
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        \n");
      out.write("        <!--Reset Password DBMS page-->\n");
      out.write("        ");
            ...
            try
            {
                String passchangequery = "select * from account where accno='"+userid+"'";
                ...
                if(count > 0)
                {
                    out.println("<br><br><center><div><h1 class='margin:5%;'>User Id Match</h1></div></center>");
                    ...
                    {
                        out.println("<center><div><h1 class='margin:5%;'>New password and confirm password are not match</h1></div></center>");
                    }
                }
                else
                {
                    out.println("<center><div><h1 class='margin:5%;'>User Id does not Match</h1></div></center>");
