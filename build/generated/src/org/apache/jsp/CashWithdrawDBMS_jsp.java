...
public final class CashWithdrawDBMS_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("        ");
            ...
            try
            {
                ...
                String withdrawquery = "insert into transactionbank values(?,?,?,?,?,?,?)";
			...
			if (t < 4)
                ...
                out.println("<br><br><center><div><h1 class='margin:5%;'>Transaction Success "+answer+" Cash Withdraw from bank transaction table</h1></div></center>");
                ...
                String withdrawquerycustomer = "insert into "+accno+" values(?,?,?,?,?,?,?)";
                
                PreparedStatement pst3 = con.prepareStatement(withdrawquerycustomer);
                ...
                out.println("<br><br><center><div><h1 class='margin:5%;'>Transaction Success "+answer+" Cash Withdraw from "+accno+" transaction table</h1></div></center>");
                
            }
            catch(Exception e)
            {
                out.println("<br><br><center><div><h1 class='margin:5%;'>Transaction Failed... Cash not Withdraw</h1></div></center>");
            }
