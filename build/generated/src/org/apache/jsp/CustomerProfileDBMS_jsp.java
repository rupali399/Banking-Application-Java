    ...
    try {
      ...
      out.write("        ");
            ...
            try
            {
                ...
                while(rs.next())
                {
                    out.println("<center><div><h4 class='margin:5%;'>Account No. : "+rs.getString(1)+"</h4></div></center>");
                    out.println("<center><div><h4 class='margin:5%;'>Name : "+rs.getString(2)+"</h4></div></center>");
                    out.println("<center><div><h4 class='margin:5%;'>Father Name : "+rs.getString(3)+"</h4></div></center>");
                    out.println("<center><div><h4 class='margin:5%;'>Date of Birth : "+rs.getString(4)+"</h4></div></center>");
                    out.println("<center><div><h4 class='margin:5%;'>Gender : "+rs.getString(5)+"</h4></div></center>");
                    out.println("<center><div><h4 class='margin:5%;'>Account Opening Date : "+rs.getString(6)+"</h4></div></center>");
                    out.println("<center><div><h4 class='margin:5%;'>Address : "+rs.getString(7)+"</h4></div></center>");
                    out.println("<center><div><h4 class='margin:5%;'>Contact Number : "+rs.getInt(8)+"</h4></div></center>");
                    out.println("<center><div><h4 class='margin:5%;'>Role : "+rs.getString(9)+"</h4></div></center>");
                    out.println("<center><div><h4 class='margin:5%;'>Password : "+rs.getString(10)+"</h4></div></center>");
                    out.println("<center><div><h4 class='margin:5%;'>Security Question : "+rs.getString(11)+"</h4></div></center>");
                    out.println("<center><div><h4 class='margin:5%;'>Security Answer : "+rs.getString(12)+"</h4></div></center>");
                    out.println("<center><div><h4 class='margin:5%;'>Status : "+rs.getString(13)+"</h4></div></center>");
                }
            }
            catch(Exception e)
            {
      ...
      out.write("       \n");
      out.write("        <center>  \n");
      out.write("             <div><h1 class=\"margin:5%;\">You can also update your profile</h1>\n");
      out.write("             </div></center>\n");
      out.write("        <center>\n");
      out.write("            \n");
      out.write("        <h4><a href=\"UpdateCustomer.jsp\"><input type=\"submit\" name=\"update\" value=\"Update Profile\"></a></h4>\n");
      out.write("        \n");
      out.write("    </body>\n");
      out.write("</html>");
    } catch (Throwable t) {
