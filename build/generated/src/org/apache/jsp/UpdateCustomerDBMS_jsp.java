...
public final class UpdateCustomerDBMS_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        ");
        ...
        try
        {
            String updateprofilequery="update account set "+fields+"='"+upvalue+"' where accno='"+session.getAttribute("login_id")+"'";
            PreparedStatement pst=con.prepareStatement(updateprofilequery);
                    
            pst.executeUpdate();
            out.println("<br><br><center><div><h1 class='margin:5%;'>Data Updated Successfully</h1></div></center>");
        }
        catch(Exception e)
        {
            out.println("<br><br><center><div><h1 class='margin:5%;'>Data Does Not Updated</h1></div></center>");
        }
