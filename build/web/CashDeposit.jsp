...
<html>
    ...
    <body style="display: static;
        ...
        <center>
        <center><div><h1 class='margin:5%;'>Transaction for Customer Cash Deposit</h1></div></center>

        <h3>
            <form action="CashDepositDBMS.jsp" method="post" style="position:static;  
                    margin-top: 5%; 
                    margin-left: 15%;
                    margin-right: 13%;
                ...
                <tr style="width: 80%;
                           ...
                           padding: 5%;
                           font-size: 20px;">
                    <td style="width: 50%">Deposit Amount</td>
                ...
                <tr style="width: 80%;
                           ...
                           padding: 5%;
                           font-size: 20px;">
                    <td style="width: 50%"><input type="submit" name="b1" value="Deposit"></td>
