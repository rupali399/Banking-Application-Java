<html>
    ...
    <body style="display: static;
        ...
        <center><br>
        <center>  
             <div><h1 class="margin:5%;">You can Reset the password Of any customer</h1>
             </div></center>
        <center>
        ...
        <form action='AdminChangePasswordDBMS.jsp' method='post' style="position:static;  
            ...
            <tr style="width: 80%;
                           ...
                           padding: 5%;
                           font-size: 20px;">
                <td style="width: 50%">Enter User ID</td>
                <td style="width: 50%"><input type="text" name="usrid"></td>
            </tr>
            ...
            <tr style="width: 80%;
                           ...
                           padding: 5%;
                           font-size: 20px;">
                    <td style="width: 50%"><input type="submit" name="b1" value="Change Password"></td>
