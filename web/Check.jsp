...
<html>
    ...
    <body style="display: static;
        ...
        <%
            ...
            //String accountholdername = "select custname from account where accno="++""
            ...
            try
            {
                ...
                while(rs1.next())
                {
                    ...
                    if(role.equalsIgnoreCase(rs1.getString(9)) && loginid.equalsIgnoreCase(rs1.getString(1)) && loginpassword.equals(rs1.getString(10)))
                    {
                        ...
                        {
                            out.println("<br><br><center><div><h1 class='margin:5%;'>Sorry! Login Failed Your account is deactivated</h1></div></center>");
                        }
                    }
                }
                
                session.setAttribute("account_holder", accountholdername);
                session.setAttribute("birth_date", birthdate);
                session.setAttribute("op_date", opdate);
                ...
                else
                {
                        ...
                        out.println("<br><br><center><div><h1 class='margin:5%;'>Invalid Credentials.....Login Failed</h1></div></center>");
                }
