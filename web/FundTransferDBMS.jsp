    ...
    <body style="display: static;
        ...
        <%
            ...
            try
            {
                ...
                String depositequery = "insert into "+accno+" value(?,?,?,?,?,?,?)";
			...
			if (t < 4)
                ...
                out.println("<br><br><center><div><h1 class='margin:5%;'>"+answer+" Cash Transfer Successfully....In "+refname+" Table</h1></div></center>");
                ...
                String depositequerycustomer = "insert into "+refname+" value(?,?,?,?,?,?,?)";
                ...
                out.println("<br><br><center><div><h1 class='margin:5%;'><br>"+answer+" Cash Transfer Successfully....From "+accno+" Table</h1></div></center>");
            }
            catch(Exception e)
            {
                out.println("<br><br><center><div><h1 class='margin:5%;'><br>Cash Not Deposit</h1></div></center>");
            }
