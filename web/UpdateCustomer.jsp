<html>
    ...
    <body style="display: static;
        ...
        <center><br>
        <center>  
             <div><h1 class="margin:5%;">Here you can update profile</h1>
             </div></center>
        <center>
        ...
        <form action="UpdateCustomerDBMS.jsp" method="post"  style="position:static;  
            ...
            <table>
                ...
                <tr style="width: 80%;
                           ...
                           padding: 5%;
                           font-size: 20px;">
                    <td style="width: 50%">Select which you want to update</td>
                    <td style="width: 50%"><select name="field">
                ...
                <tr style="width: 80%;
                           ...
                           padding: 5%;
                           font-size: 20px;">
                    <td style="width: 50%">Enter Updated Value</td>
                    <td style="width: 50%"><input type="text" name="upvalue"></td>
                </tr>
                ...
                <tr style="width: 80%;
                           ...
                           padding: 5%;
                           font-size: 20px;">
                    <td style="width: 50%"><input type="submit" name="update" value="Update"></td>
                </tr>
