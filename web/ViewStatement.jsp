<html>
    ...
    <body style="display: static;
        ...
        <center>
            ...
            <h3 align="center">
                <form action="ViewStatementDBMS.jsp" method="post" style="position:static;  
                    margin-top: 5%; 
                    margin-left: 30%;
                    margin-right: 13%;
                    ...
                    <table>
                        <tr style="width: 80%;
                           ...
                           font-size: 20px;">
                            ...
                            <td style="width: 50%"><select name="choice">
                        ...
                        <tr style="width: 80%;
                           ...
                           padding: 5%;
                           font-size: 20px;">
                            <td style="width: 50%"><input type="text" name="cuschoice"></td>
                            <td style="width: 50%"><input type="submit" name="b1" value="View"></td>
                        </tr>
